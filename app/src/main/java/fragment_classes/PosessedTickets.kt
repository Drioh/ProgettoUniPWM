...
class PosessedTickets : Fragment(R.layout.fragment_posessed_tickets) {
    ...
    override fun onCreateView(
        ...
        dbManager.open()
        //dbManager.insertAbbonamento("Massimo", "11/12/2001", "05/05/2002")
        //dbManager.insertBiglietto("Pinocchio", "02/02/2010")
        //dbManager.insertAbbonamento("Politeama", "11/11/2011", "04/04/2022")
        //dbManager.insertBiglietto("Massimo Boldi - Il film", "20/08/2021")
        //dbManager.insertAbbonamento("Biondo", "09/09/2009", "07/07/2012")
        //dbManager.insertBiglietto("Truce Baldazzi Live Show", "10/06/2023")
